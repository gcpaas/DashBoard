(function(window) {
  window.SITE_CONFIG = {
    ...
    starter:{
      ...
      // 底部html设置
      footer: {
        copyright: '仪表盘设计器 V2.1.0 <a href="http://www.kdgcsoft.com/" target="_blank" class="no-decoration">生态平台PBU</a> 2026  |  版权所有 © <a href="http://www.gccloud.com/" target="_blank">科大国创云网科技有限公司</a>',
      },
      login:{
        // 账号登陆时 验证码间隔
        account: {
