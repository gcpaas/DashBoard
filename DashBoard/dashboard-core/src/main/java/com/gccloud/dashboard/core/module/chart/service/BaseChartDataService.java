...
public class BaseChartDataService {
    ...
    static final Cache<String, Object> CHART_CACHE_1M = Caffeine.newBuilder().expireAfterWrite(1, TimeUnit.MINUTES).build();

    static final Cache<String, Object> CHART_CACHE_2M = Caffeine.newBuilder().expireAfterWrite(2, TimeUnit.MINUTES).build();

    static final Cache<String, Object> CHART_CACHE_5M = Caffeine.newBuilder().expireAfterWrite(5, TimeUnit.MINUTES).build();

    static final Cache<String, Object> CHART_CACHE_10M = Caffeine.newBuilder().expireAfterWrite(10, TimeUnit.MINUTES).build();
